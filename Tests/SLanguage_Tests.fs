...
[<TestFixture>] 
type ``SLanguage Tests`` () = 
    [<Test>] 
    member v.``Test ToString of Var and Call.`` () =
    ...
    [<Test>]
    member v.``Test ToString of Program.`` () = 
